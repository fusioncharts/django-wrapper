...
# The `fc_scatter` method is defined to load chart data from a JSON string.

def fc_scatter(request):
	...
	# pass the URL of that file to the `dataSource` parameter.
 	...
 	return  render(request, 'fusioncharts-html-template.html', {'output' : scatterChart.render()})