...
# The `fc_map` method is defined to load chart data from a JSON string.

def fc_map(request):
	fusionMap = FusionCharts("usa", "ex1" , "650", "450", "chart-1", "json", 
		"""{
      "chart": {
  ...
  # pass the URL of that file to the `dataSource` parameter.
 	...
 	return  render(request, 'fusioncharts-html-template.html', {'output' : fusionMap.render()})
