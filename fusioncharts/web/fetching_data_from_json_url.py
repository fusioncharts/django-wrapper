...
# The `fc_jsonurl` method is defined to load chart data from an JSON string.

def fc_jsonurl(request):
  # Create an object for the column2d chart using the FusionCharts class constructor
  column2d = FusionCharts("column2d", "ex1" , "600", "400", "chart-1", "jsonurl","http://127.0.0.1:8000/static/data/data.json")
